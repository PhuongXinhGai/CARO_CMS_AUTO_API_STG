...
public class  VoucherRemovePlayer2Test extends TestConfig implements FlowRunnable {
    ...
    public void testVoucherRemovePlayer2(Map<String, String> row, ITestContext ctx) throws IOException {
    ...
    public void runCase(String caseId, ITestContext ctx, ExtentTest logger) throws Exception {
        ...
        testVoucherRemovePlayer2(row, ctx);   // chỉ gọi lại hàm test cũ
    }
