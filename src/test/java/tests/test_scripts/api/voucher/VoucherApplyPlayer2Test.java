...
public class  VoucherApplyPlayer2Test extends TestConfig implements FlowRunnable {
    // ==== ĐƯỜNG DẪN — chỉnh cho khớp project của bạn ====
    private static final String EXCEL_FILE = System.getProperty("user.dir")
            + "/src/main/resources/input_excel_file/booking/voucher.xlsx";
    private static final String SHEET_NAME = "Voucher_Apply_Player2";
    ...
    public void testVoucherApplyPlayer2(Map<String, String> row, ITestContext ctx) throws IOException {
    ...
    public void runCase(String caseId, ITestContext ctx, ExtentTest logger) throws Exception {
        ...
        testVoucherApplyPlayer2(row, ctx);   // chỉ gọi lại hàm test cũ
    }
