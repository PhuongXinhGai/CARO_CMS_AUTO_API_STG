...
public class VoucherApplyBulkTest extends TestConfig implements FlowRunnable {
    ...
    public void testVoucherApplyBulkAdd(Map<String, String> row, ITestContext ctx) throws IOException {
        ...
        ExtractHelper.extractVoucherApplyBulk(requestBody, ctx);
    ...
    public void runCase(String caseId, ITestContext ctx, ExtentTest logger) throws Exception {
        ...
        testVoucherApplyBulkAdd(row, ctx);   // chỉ gọi lại hàm test cũ
    }
