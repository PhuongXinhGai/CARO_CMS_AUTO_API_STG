...
public class BookingVoucherCheckTest extends TestConfig implements FlowRunnable {
    // ==== ĐƯỜNG DẪN — chỉnh cho khớp project của bạn ====
    private static final String EXCEL_FILE = System.getProperty("user.dir")
            + "/src/main/resources/input_excel_file/booking/Voucher.xlsx";
    private static final String SHEET_NAME = "Booking_Voucher_Check";
    // Thư mục chứa JSON request/expect cho API này
    private static final String JSON_DIR = System.getProperty("user.dir")
            + "/src/main/resources/input_json_file/voucher/voucher_check/";

    // ======================= DataProvider =======================
    @DataProvider(name = "voucherCheckData")
    public Object[][] voucherCheckData() throws IOException {
     ...
     */
    @Test(dataProvider = "voucherCheckData")
    public void testVoucherCheck(Map<String, String> row, ITestContext ctx) throws IOException {
        ...
        Response resp = given()
                        ...
                        .body(requestBody)
                        .when()
                        .post(BASE_URL_MAINTENANCE + CHECK_ENDPOINT)
                        .then()
                        .extract().response();
        ...
        String url = BASE_URL_MAINTENANCE + CHECK_ENDPOINT;
    ...
    public void runCase(String caseId, ITestContext ctx, ExtentTest logger) throws Exception {
        ...
        testVoucherCheck(row, ctx);   // chỉ gọi lại hàm test cũ
    }
