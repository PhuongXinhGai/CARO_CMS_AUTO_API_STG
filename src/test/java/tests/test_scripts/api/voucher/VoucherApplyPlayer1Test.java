...
public class  VoucherApplyPlayer1Test extends TestConfig implements FlowRunnable {
    // ==== ĐƯỜNG DẪN — chỉnh cho khớp project của bạn ====
    private static final String EXCEL_FILE = System.getProperty("user.dir")
            + "/src/main/resources/input_excel_file/booking/voucher.xlsx";
    private static final String SHEET_NAME = "Voucher_Apply_Player1";
    ...
    public void testVoucherApplyPlayer1(Map<String, String> row, ITestContext ctx) throws IOException {
    ...
    public void runCase(String caseId, ITestContext ctx, ExtentTest logger) throws Exception {
        ...
        testVoucherApplyPlayer1(row, ctx);   // chỉ gọi lại hàm test cũ
    }
