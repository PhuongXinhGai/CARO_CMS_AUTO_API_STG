...
public class  VoucherRemovePlayer4Test extends TestConfig implements FlowRunnable {
    // ==== ĐƯỜNG DẪN — chỉnh cho khớp project của bạn ====
    private static final String EXCEL_FILE = System.getProperty("user.dir")
            + "/src/main/resources/input_excel_file/booking/Voucher.xlsx";
    private static final String SHEET_NAME = "Voucher_Remove_Player4";
    // Thư mục chứa JSON request/expect cho API này
    private static final String JSON_DIR = System.getProperty("user.dir")
            + "/src/main/resources/input_json_file/voucher/voucher_golf_fee_remove/";

    // ======================= DataProvider =======================
    @DataProvider(name = "voucherRemoveData")
    public Object[][] voucherRemoveData() throws IOException {
     ...
     */
    @Test(dataProvider = "voucherRemoveData")
    public void testVoucherRemovePlayer4(Map<String, String> row, ITestContext ctx) throws IOException {
        ...
        Response resp = given()
                        ...
                        .body(requestBody)
                        .when()
                        .post(BASE_URL + GOLF_FEE_REMOVE_ENDPOINT)
                        .then()
                        .extract().response();
        ...
        String url = BASE_URL + GOLF_FEE_REMOVE_ENDPOINT;
    ...
    public void runCase(String caseId, ITestContext ctx, ExtentTest logger) throws Exception {
        ...
        testVoucherRemovePlayer4(row, ctx);   // chỉ gọi lại hàm test cũ
    }
