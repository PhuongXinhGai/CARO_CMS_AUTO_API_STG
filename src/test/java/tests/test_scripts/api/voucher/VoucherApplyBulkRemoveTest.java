...
public class  VoucherApplyBulkRemoveTest extends TestConfig implements FlowRunnable {
    // ==== ĐƯỜNG DẪN — chỉnh cho khớp project của bạn ====
    private static final String EXCEL_FILE = System.getProperty("user.dir")
            + "/src/main/resources/input_excel_file/booking/voucher.xlsx";
    private static final String SHEET_NAME = "Voucher_Apply_Bulk_Remove";
    ...
    // ======================= DataProvider =======================
    @DataProvider(name = "voucherApplyBulkData")
    public Object[][] voucherApplyBulkData() throws IOException {
     ...
     */
    @Test(dataProvider = "voucherApplyBulkData")
    public void testVoucherApplyBulkRemove(Map<String, String> row, ITestContext ctx) throws IOException {
        ...
        Response resp = given()
                        ...
                        .body(requestBody)
                        .when()
                        .post(BASE_URL + GOLF_FEE_APPLY_BULK_ENDPOINT)
                        .then()
                        .extract().response();
        ...
        String url = BASE_URL + GOLF_FEE_APPLY_BULK_ENDPOINT;
    ...
    public void runCase(String caseId, ITestContext ctx, ExtentTest logger) throws Exception {
        ...
        testVoucherApplyBulkRemove(row, ctx);   // chỉ gọi lại hàm test cũ
    }
