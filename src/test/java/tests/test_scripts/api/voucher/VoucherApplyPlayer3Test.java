...
public class  VoucherApplyPlayer3Test extends TestConfig implements FlowRunnable {
    // ==== ĐƯỜNG DẪN — chỉnh cho khớp project của bạn ====
    private static final String EXCEL_FILE = System.getProperty("user.dir")
            + "/src/main/resources/input_excel_file/booking/Voucher.xlsx";
    private static final String SHEET_NAME = "Voucher_Apply_Player3";
    ...
    public void testVoucherApplyPlayer3(Map<String, String> row, ITestContext ctx) throws IOException {
    ...
    public void runCase(String caseId, ITestContext ctx, ExtentTest logger) throws Exception {
        ...
        testVoucherApplyPlayer3(row, ctx);   // chỉ gọi lại hàm test cũ
    }
