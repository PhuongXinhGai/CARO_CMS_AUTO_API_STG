...
public class AddSubBagTest extends TestConfig implements FlowRunnable {
    ...
    private static final String SHEET_NAME = "Add_Sub_Bag";
    // Thư mục chứa JSON request/expect cho API này
    private static final String JSON_DIR = System.getProperty("user.dir")
            + "/src/main/resources/input_json_file/cico/add_sub_bag/";

    // ======================= DataProvider =======================
    @DataProvider(name = "addSubBagData")
    public Object[][] addSubBagData() throws IOException {
