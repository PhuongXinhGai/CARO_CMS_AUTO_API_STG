...
public class CheckOutBagTest extends TestConfig implements FlowRunnable {
    ...
    private static final String SHEET_NAME = "Check_Out_Bag";
    // Thư mục chứa JSON request/expect cho API này
    private static final String JSON_DIR = System.getProperty("user.dir")
            + "/src/main/resources/input_json_file/cico/check_out_bag/";

    // ======================= DataProvider =======================
    @DataProvider(name = "checkOutBagData")
    public Object[][] checkOutBagData() throws IOException {
     ...
     */
    @Test(dataProvider = "checkOutBagData")
    public void testCheckOutBag(Map<String, String> row, ITestContext ctx) throws IOException {
