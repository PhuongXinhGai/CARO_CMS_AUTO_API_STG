...
public class GetFeeOfBagBillPlayer2Test extends TestConfig implements FlowRunnable {
    // ==== ĐƯỜNG DẪN — chỉnh cho khớp project của bạn ====
    private static final String EXCEL_FILE = System.getProperty("user.dir")
            + "/src/main/resources/input_excel_file/booking/CICO.xlsx";
    private static final String SHEET_NAME = "Fee_Of_Bag_Bill_Player2";
...
// Lấy từ context
        ...
        String bagCtx  = (String) ctx.getAttribute("BAG_1");
