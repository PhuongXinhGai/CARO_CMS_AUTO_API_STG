...
public class GetFeeOfBagBillPlayer1Test extends TestConfig implements FlowRunnable {
    // ==== ĐƯỜNG DẪN — chỉnh cho khớp project của bạn ====
    private static final String EXCEL_FILE = System.getProperty("user.dir")
            + "/src/main/resources/input_excel_file/booking/CICO.xlsx";
    private static final String SHEET_NAME = "Fee_Of_Bag_Bill_Player1";
    // Thư mục chứa JSON request/expect cho API này
    private static final String JSON_DIR = System.getProperty("user.dir")
            + "/src/main/resources/input_json_file/cico/fee_of_bag_bill/";

    // ======================= DataProvider =======================
    @DataProvider(name = "getFeeOfBagBillData")
    public Object[][] getFeeOfBagBillData() throws IOException {
     ...
     */
    @Test(dataProvider = "getFeeOfBagBillData")
    public void testGetFeeOfBagBill(Map<String, String> row, ITestContext ctx) throws IOException {
...
// Lấy từ context
        ...
        String bagCtx  = (String) ctx.getAttribute("BAG_0");
...
// Query params: context + excel
        ...
        q.put("is_calc_detail_tax_and_fee", row.get("is_calc_detail_tax_and_fee"));
...
// ===== Step 3: Call API =====
        Response resp = given()
                ...
                .queryParams(q)
                .when()
                .get(BASE_URL + "/golf-cms/api/booking/fee-of-bag-bill")
                .then()
                .extract()
                .response();
        ...
        String url = BASE_URL + "/golf-cms/api/booking/fee-of-bag-bill";
    ...
    public void runCase(String caseId, ITestContext ctx, ExtentTest logger) throws Exception {
        ...
        testGetFeeOfBagBill(row, ctx);   // chỉ gọi lại hàm test cũ
    }
