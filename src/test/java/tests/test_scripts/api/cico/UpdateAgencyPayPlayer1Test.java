...
import static common.utilities.Constants.UPDATE_AGENCY_PAY_ENDPOINT;
import static io.restassured.RestAssured.given;

public class UpdateAgencyPayPlayer1Test extends TestConfig implements FlowRunnable {
    // ==== ĐƯỜNG DẪN — chỉnh cho khớp project của bạn ====
    private static final String EXCEL_FILE = System.getProperty("user.dir")
            + "/src/main/resources/input_excel_file/booking/CICO.xlsx";
    private static final String SHEET_NAME = "Update_Agency_Pay_Player1";
    ...
    public void testUpdateAgencyPay(Map<String, String> row, ITestContext ctx) throws IOException {
        ...
        Response resp = given()
                ...
                .body(requestBody)
                .when()
                .put(BASE_URL + UPDATE_AGENCY_PAY_ENDPOINT + booking_uid)
                .then()
                .extract().response();
        ...
        String url = BASE_URL + UPDATE_AGENCY_PAY_ENDPOINT;
