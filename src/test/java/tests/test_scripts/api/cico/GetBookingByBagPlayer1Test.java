...
public class GetBookingByBagPlayer1Test extends TestConfig implements FlowRunnable {
    // ==== ĐƯỜNG DẪN — chỉnh cho khớp project của bạn ====
    private static final String EXCEL_FILE = System.getProperty("user.dir")
            + "/src/main/resources/input_excel_file/booking/CICO.xlsx";
    private static final String SHEET_NAME = "Booking_By_Bag_Player1";
    // Thư mục chứa JSON request/expect cho API này
    private static final String JSON_DIR = System.getProperty("user.dir")
            + "/src/main/resources/input_json_file/cico/booking_by_bag/";

    // ======================= DataProvider =======================
    @DataProvider(name = "getBookingByBagData")
    public Object[][] getBookingByBagData() throws IOException {
     ...
     */
    @Test(dataProvider = "getBookingByBagData")
    public void testGetBookingByBag(Map<String, String> row, ITestContext ctx) throws IOException {
