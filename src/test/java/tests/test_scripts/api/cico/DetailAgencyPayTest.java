...
public class DetailAgencyPayTest extends TestConfig implements FlowRunnable {
    ...
    private static final String SHEET_NAME = "Detail_Agency_Pay";
    // Thư mục chứa JSON request/expect cho API này
    private static final String JSON_DIR = System.getProperty("user.dir")
            + "/src/main/resources/input_json_file/cico/detail_agency_pay/";

    // ======================= DataProvider =======================
    @DataProvider(name = "detailAgencyPayData")
    public Object[][] detailAgencyPayData() throws IOException {
     ...
     */
    @Test(dataProvider = "detailAgencyPayData")
    public void testDetailAgencyPay(Map<String, String> row, ITestContext ctx) throws IOException {
