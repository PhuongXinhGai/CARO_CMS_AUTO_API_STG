...
import static common.utilities.Constants.SINGLE_PAYMENT_LIST_ENDPOINT;
...
public class SinglePaymentListTest extends TestConfig implements FlowRunnable {
    ...
    public void testSinglePaymentList(Map<String, String> row, ITestContext ctx) throws IOException {
        ...
        Response resp = given()
                ...
                .body(requestBody)
                .when()
                .post(BASE_URL + SINGLE_PAYMENT_LIST_ENDPOINT)
                .then()
                .extract().response();
        ...
        String url = BASE_URL + SINGLE_PAYMENT_LIST_ENDPOINT;
