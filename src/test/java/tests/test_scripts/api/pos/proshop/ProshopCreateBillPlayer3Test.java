...
public class ProshopCreateBillPlayer3Test extends TestConfig implements FlowRunnable {

    // ==== ĐƯỜNG DẪN — chỉnh cho khớp project của bạn ====
    private static final String EXCEL_FILE = System.getProperty("user.dir")
            + "/src/main/resources/input_excel_file/booking/POS.xlsx";
    private static final String SHEET_NAME = "Proshop_Create_Bill_Player3";
    ...
    public void testCreateBill(Map<String, String> row, ITestContext ctx) throws IOException {
        ...
        if (bill_id != null)      ctx.setAttribute("BILL_ID_2", bill_id);
