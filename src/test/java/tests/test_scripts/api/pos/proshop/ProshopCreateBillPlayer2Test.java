package tests.test_scripts.api.pos.proshop;
...
public class ProshopCreateBillPlayer2Test extends TestConfig implements FlowRunnable {
    ...
    public void testCreateBill(Map<String, String> row, ITestContext ctx) throws IOException {
        ...
        if (bill_id != null)      ctx.setAttribute("BILL_ID_1", bill_id);
