...
import static common.utilities.Constants.ADD_BAG_TO_FLIGHT_ENDPOINT;
import static io.restassured.RestAssured.given;

public class AddBagToFlightTest extends TestConfig implements FlowRunnable {
    ...
    private static final String SHEET_NAME = "Add_Bag_To_Flight";
    // Thư mục chứa JSON request/expect cho API này
    private static final String JSON_DIR = System.getProperty("user.dir")
            + "/src/main/resources/input_json_file/go_course_information/add_bag_to_flight/";

    // ======================= DataProvider =======================
    @DataProvider(name = "addBagToFlightData")
    public Object[][] addBagToFlightData() throws IOException {
     ...
     */
    @Test(dataProvider = "addBagToFlightData")
    public void testAddBagToFlight(Map<String, String> row, ITestContext ctx) throws IOException {
        ...
        Response resp = given()
                ...
                .body(requestBody)
                .when()
                .post(BASE_URL + ADD_BAG_TO_FLIGHT_ENDPOINT)
                .then()
                .extract().response();
        ...
        String url = BASE_URL + ADD_BAG_TO_FLIGHT_ENDPOINT;
    ...
    public void runCase(String caseId, ITestContext ctx, ExtentTest logger) throws Exception {
        ...
        testAddBagToFlight(row, ctx);   // chỉ gọi lại hàm test cũ
    }
