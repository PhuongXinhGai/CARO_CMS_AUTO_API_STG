...
import static common.utilities.Constants.ADD_ROUND_ENDPOINT;
import static io.restassured.RestAssured.given;

public class AddRoundPlayer1Test extends TestConfig implements FlowRunnable {
    ...
    // ======================= DataProvider =======================
    @DataProvider(name = "addRoundData")
    public Object[][] addRoundData() throws IOException {
     ...
     */
    @Test(dataProvider = "addRoundData")
    public void testAddRound(Map<String, String> row, ITestContext ctx) throws IOException {
        ...
        Response resp = given()
                ...
                .body(requestBody)
                .when()
                .post(BASE_URL + ADD_ROUND_ENDPOINT)
                .then()
                .extract().response();
        ...
        String url = BASE_URL + ADD_ROUND_ENDPOINT;
    ...
    public void runCase(String caseId, ITestContext ctx, ExtentTest logger) throws Exception {
        ...
        testAddRound(row, ctx);   // chỉ gọi lại hàm test cũ
    }
