...
import static common.utilities.Constants.SIMPLE_OUT_FLIGHT_ENDPOINT;
import static io.restassured.RestAssured.given;

public class SimpleOutFlightPlayer1Test extends TestConfig implements FlowRunnable {
    ...
    private static final String SHEET_NAME = "Simple_Out_Flight_Player1";
    // Thư mục chứa JSON request/expect cho API này
    private static final String JSON_DIR = System.getProperty("user.dir")
            + "/src/main/resources/input_json_file/go_course_information/simple_out_flight/";

    // ======================= DataProvider =======================
    @DataProvider(name = "simpleOutFlightData")
    public Object[][] simpleOutFlightData() throws IOException {
     ...
     */
    @Test(dataProvider = "simpleOutFlightData")
    public void testSimpleOutFlight(Map<String, String> row, ITestContext ctx) throws IOException {
        ...
        Response resp = given()
                ...
                .body(requestBody)
                .when()
                .post(BASE_URL + SIMPLE_OUT_FLIGHT_ENDPOINT)
                .then()
                .extract().response();
        ...
        String url = BASE_URL + SIMPLE_OUT_FLIGHT_ENDPOINT;
    ...
    public void runCase(String caseId, ITestContext ctx, ExtentTest logger) throws Exception {
        ...
        testSimpleOutFlight(row, ctx);   // chỉ gọi lại hàm test cũ
    }
