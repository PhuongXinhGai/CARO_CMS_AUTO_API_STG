...
public class DeleteAttachFlightPlayer2Test extends TestConfig implements FlowRunnable {
    ...
    private static final String SHEET_NAME = "Delete_Attach_Flight_Player2";
