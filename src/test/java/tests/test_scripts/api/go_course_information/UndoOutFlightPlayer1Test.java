...
import static common.utilities.Constants.UNDO_OUT_FLIGHT_ENDPOINT;
import static io.restassured.RestAssured.given;

public class UndoOutFlightPlayer1Test extends TestConfig implements FlowRunnable {
    ...
    private static final String SHEET_NAME = "Undo_Out_Flight_Player1";
    ...
    public void testUndoOutFlight(Map<String, String> row, ITestContext ctx) throws IOException {
        ...
        Response resp = given()
                ...
                .body(requestBody)
                .when()
                .post(BASE_URL + UNDO_OUT_FLIGHT_ENDPOINT)
                .then()
                .extract().response();
        ...
        String url = BASE_URL + UNDO_OUT_FLIGHT_ENDPOINT;
