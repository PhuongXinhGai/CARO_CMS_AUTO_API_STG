...
public class RevenueDetailReportPlayer1Test extends TestConfig implements FlowRunnable {
    // ==== ĐƯỜNG DẪN — chỉnh cho khớp project của bạn ====
    private static final String EXCEL_FILE = System.getProperty("user.dir")
            + "/src/main/resources/input_excel_file/booking/Report.xlsx";
    private static final String SHEET_NAME = "Revenue_Detail_Report_Player1";
...
// Lấy từ context
        ...
        String bagCode = (String) ctx.getAttribute("BAG_0");
        if (bagCode == null) {
            throw new AssertionError("BAG_0 không tồn tại trong context");
        }
