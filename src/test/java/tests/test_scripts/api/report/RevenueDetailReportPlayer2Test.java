...
public class RevenueDetailReportPlayer2Test extends TestConfig implements FlowRunnable {
    // ==== ĐƯỜNG DẪN — chỉnh cho khớp project của bạn ====
    private static final String EXCEL_FILE = System.getProperty("user.dir")
            + "/src/main/resources/input_excel_file/booking/Report.xlsx";
    private static final String SHEET_NAME = "Revenue_Detail_Report_Player2";
...
// ===== Step 3: Call API =====
        ...
        String bagCode = (String) ctx.getAttribute("BAG_1");
        if (bagCode == null) {
            throw new AssertionError("BAG_1 không tồn tại trong context");
        }
