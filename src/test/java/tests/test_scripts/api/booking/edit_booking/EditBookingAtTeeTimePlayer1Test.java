...
public class EditBookingAtTeeTimePlayer1Test extends TestConfig implements FlowRunnable {
    ...
    private static final String SHEET_NAME = "Edit_Booking_At_TeeTime_Player1";
