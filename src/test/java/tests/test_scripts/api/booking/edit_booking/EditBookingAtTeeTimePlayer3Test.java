...
import static common.utilities.Constants.BOOKING_UPDATE_AT_TEE_TIME_ENDPOINT;
import static io.restassured.RestAssured.given;

public class EditBookingAtTeeTimePlayer3Test extends TestConfig implements FlowRunnable {
    ...
    private static final String SHEET_NAME = "Edit_Booking_At_TeeTime_Player3";
    ...
    public void testEditBooking(Map<String, String> row, ITestContext ctx) throws IOException {
        ...
        String booking_uid = (String) ctx.getAttribute("BOOKING_UID_2");
        ...
        Response resp = given()
                ...
                .body(requestBody)
                .when()
                .put(BASE_URL + BOOKING_UPDATE_AT_TEE_TIME_ENDPOINT + booking_uid)
                .then()
                .extract().response();
        ...
        String url = BASE_URL + BOOKING_UPDATE_AT_TEE_TIME_ENDPOINT + booking_uid;
