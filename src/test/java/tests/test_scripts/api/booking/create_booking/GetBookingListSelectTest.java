...
public class  GetBookingListSelectTest extends TestConfig implements FlowRunnable {
    ...
    public Object[][] getBookingListSelectData() throws IOException {
    ...
    public void testGetBookingSelectList(Map<String, String> row, ITestContext ctx) throws IOException {
...
// ===== Step 3: Call API =====
    ...
    public void runCase(String caseId, ITestContext ctx, ExtentTest logger) throws Exception {
        ...
        testGetBookingSelectList(row, ctx);   // chỉ gọi lại hàm test cũ
    }
