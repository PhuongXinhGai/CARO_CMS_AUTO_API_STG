...
import static common.utilities.Constants.BOOKING_AT_TEE_TIME_ENDPOINT;
...
public class CreateBookingBatchAtTeeTimeTest extends TestConfig implements FlowRunnable {
    ...
    public void testCreateBookingBatch(Map<String, String> row, ITestContext ctx) throws IOException {
        ...
        Response resp = given()
                ...
                .body(requestBody)
                .when()
                .post(BASE_URL + BOOKING_AT_TEE_TIME_ENDPOINT)
                .then()
                .extract().response();
        ...
        String url = BASE_URL + BOOKING_AT_TEE_TIME_ENDPOINT;
