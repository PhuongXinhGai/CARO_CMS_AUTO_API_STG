...
public class GetBookingPricePlayer3Test extends TestConfig implements FlowRunnable {
    ...
    private static final String SHEET_NAME = "Get_Booking_Price_Player3";
...
// Lấy BOOKING_UID_0
        String bookingUid = (String) ctx.getAttribute("BOOKING_UID_2");
        if (bookingUid == null) {
            throw new AssertionError("BOOKING_UID_2 không tồn tại trong context");
        }
