...
public class CheckInBagPlayer3Test extends TestConfig implements FlowRunnable {

    // ==== ĐƯỜNG DẪN — chỉnh cho khớp project của bạn ====
    private static final String EXCEL_FILE = System.getProperty("user.dir")
            + "/src/main/resources/input_excel_file/booking/CheckIn.xlsx";
    private static final String SHEET_NAME = "Check_In_Bag_Player3";
...
//         JsonPath jp = new JsonPath(respJson);
        ...
        if (round_id != null)      ctx.setAttribute("ROUND_ID_2", round_id);
