...
import static common.utilities.Constants.CHECKIN_EKYC_ENDPOINT;
import static io.restassured.RestAssured.given;

public class CheckInEkycPlayer2Test extends TestConfig implements FlowRunnable {

    // ==== ĐƯỜNG DẪN — chỉnh cho khớp project của bạn ====
    private static final String EXCEL_FILE = System.getProperty("user.dir")
            + "/src/main/resources/input_excel_file/booking/CheckIn.xlsx";
    private static final String SHEET_NAME = "Check_In_Ekyc_Player2";
...
//                .header("Authorization", bearer != null ? bearer : "")
                .body(requestBody)
                .when()
                .post(BASE_URL + CHECKIN_EKYC_ENDPOINT)
                .then()
                .extract().response();
        ...
        String url = BASE_URL + CHECKIN_EKYC_ENDPOINT;
...
//         JsonPath jp = new JsonPath(respJson);
        ...
        if (bag != null)      ctx.setAttribute("BAG_1", bag);
    }
    //    Flow chạy tích hợp
    @Override
