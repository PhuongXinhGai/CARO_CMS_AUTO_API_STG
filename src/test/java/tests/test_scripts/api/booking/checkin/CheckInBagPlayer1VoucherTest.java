...
public class  CheckInBagPlayer1VoucherTest extends TestConfig implements FlowRunnable {
    // ==== ĐƯỜNG DẪN — chỉnh cho khớp project của bạn ====
    private static final String EXCEL_FILE = System.getProperty("user.dir")
            + "/src/main/resources/input_excel_file/booking/CheckIn.xlsx";
    private static final String SHEET_NAME = "Check_In_Bag_Player1_VC";
    ...
    // ======================= DataProvider =======================
    @DataProvider(name = "checkInBagData")
    public Object[][] checkInBagData() throws IOException {
     ...
     */
    @Test(dataProvider = "checkInBagData")
