...
public class UndoCheckInBagTest extends TestConfig implements FlowRunnable {
    ...
    private static final String SHEET_NAME = "Undo_Check_In";
    // Thư mục chứa JSON request/expect cho API này
    private static final String JSON_DIR = System.getProperty("user.dir")
            + "/src/main/resources/input_json_file/booking/undo_check_in/";

    // ======================= DataProvider =======================
    @DataProvider(name = "undoCheckInData")
    public Object[][] undoCheckInData() throws IOException {
     ...
     */
    @Test(dataProvider = "undoCheckInData")
    public void testUndoCheckInBag(Map<String, String> row, ITestContext ctx) throws IOException {
