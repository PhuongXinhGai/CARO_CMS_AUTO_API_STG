...
public class EInvoicePaymentIdPlayer3Test extends TestConfig implements FlowRunnable {

    // ==== ĐƯỜNG DẪN — chỉnh cho khớp project của bạn ====
    private static final String EXCEL_FILE = System.getProperty("user.dir")
            + "/src/main/resources/input_excel_file/booking/Invoice.xlsx";
    private static final String SHEET_NAME = "E_Invoice_Payment_ID_Player3";
    ...
    public void testEInvoice(Map<String, String> row, ITestContext ctx) throws IOException {
        ...
        String paymentId = (String) ctx.getAttribute("PAYMENT_ID_BAG_2");
        if (paymentId == null) {
            throw new AssertionError("PAYMENT_ID_BAG_2 không tồn tại trong context");
        }
