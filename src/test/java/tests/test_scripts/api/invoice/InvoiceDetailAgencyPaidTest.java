...
public class InvoiceDetailAgencyPaidTest extends TestConfig implements FlowRunnable {
    ...
    private static final String SHEET_NAME = "Invoice_Detail_Agency_Paid";
    // Thư mục chứa JSON request/expect cho API này
    private static final String JSON_DIR = System.getProperty("user.dir")
            + "/src/main/resources/input_json_file/invoice/invoice_detail_agency_paid/";

    // ======================= DataProvider =======================
    @DataProvider(name = "invoiceDetailAgencyPaidData")
    public Object[][] invoiceDetailAgencyPaidData() throws IOException {
     ...
     */
    @Test(dataProvider = "invoiceDetailAgencyPaidData")
    public void testInvoiceDetailAgencyPaid(Map<String, String> row, ITestContext ctx) throws IOException {
