...
import static common.utilities.Constants.INVOICE_DETAIL_COST_ENDPOINT;
import static io.restassured.RestAssured.given;

public class InvoiceDetailCostTest extends TestConfig implements FlowRunnable {

    // ==== ĐƯỜNG DẪN — chỉnh cho khớp project của bạn ====
    private static final String EXCEL_FILE = System.getProperty("user.dir")
            + "/src/main/resources/input_excel_file/booking/Invoice.xlsx";
    private static final String SHEET_NAME = "Invoice_Detail_Cost";
    // Thư mục chứa JSON request/expect cho API này
    private static final String JSON_DIR = System.getProperty("user.dir")
            + "/src/main/resources/input_json_file/invoice/invoice_detail_cost/";

    // ======================= DataProvider =======================
    @DataProvider(name = "invoiceDetailCostData")
    public Object[][] invoiceDetailCostData() throws IOException {
     ...
     */
    @Test(dataProvider = "invoiceDetailCostData")
    public void testInvoiceDetailCost(Map<String, String> row, ITestContext ctx) throws IOException {
        ...
        Response resp = given()
                ...
                .body(requestBody)
                .when()
                .post(BASE_URL + INVOICE_DETAIL_COST_ENDPOINT)
                .then()
                .extract().response();
        ...
        String url = BASE_URL + INVOICE_DETAIL_COST_ENDPOINT;
    ...
    public void runCase(String caseId, ITestContext ctx, ExtentTest logger) throws Exception {
        ...
        testInvoiceDetailCost(row, ctx);   // chỉ gọi lại hàm test cũ
    }
